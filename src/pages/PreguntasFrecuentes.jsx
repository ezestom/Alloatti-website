	...
	mainEntity: [
		{
			...
			acceptedAnswer: {
				"@type": "Answer",
				text: "Alloatti SRL tiene más de 30 años de experiencia en el mercado, brindando maquinaria de calidad para el procesamiento de bidones retornables y descartables.",
			},
		},
		{
			"@type": "Question",
			...
			acceptedAnswer: {
				"@type": "Answer",
				text: "Nuestras máquinas cuentan con tiempos de lavado de 120 segundos, picos de lavado exterior rotativos, puertas sin contacto con bidón y control inteligente vía pantalla táctil.",
			},
		},
		{
			"@type": "Question",
			...
			acceptedAnswer: {
				"@type": "Answer",
				text: "Ofrecemos líneas que abarcan desde 50 hasta 1000 bidones por hora, con la posibilidad de desarrollar capacidades mayores según requerimientos específicos.",
			},
		},
		{
			"@type": "Question",
		...
		},
		{
			...
			acceptedAnswer: {
				"@type": "Answer",
				text: "Garantizamos un ciclo de lavado de 120 segundos y llenado sin contacto para eliminar cualquier posibilidad de contaminación, cumpliendo con los estándares de higiene más exigentes.",
			},
		},
	],
};
				...
				<article className="lg:w-4/6 lg:ml-[300px] sm:ml-0 mb-20 px-4 md:px-0">
					<header className="hp-page-header">
						...
						<div className="grid grid-cols-3 gap-2 sm:gap-4 my-12">
							{images.map((image, index) => (
								<div
									key={index}
									className="relative group overflow-hidden rounded-2xl aspect-square shadow-xl border border-slate-200 dark:border-slate-800 bg-slate-100 dark:bg-slate-900">
									<img
										src={image}
					...
					<div className="hp-card my-12 !p-0 overflow-hidden">
						<div className="bg-slate-50 dark:bg-slate-800/50 p-6 border-b border-slate-100 dark:border-slate-700">
							<div className="hp-eyebrow hp-eyebrow-blue !bg-white dark:!bg-slate-900">
								Soporte Técnico • FAQ
							</div>
						</div>
